...
class Penilaian_Alternatif extends CI_Controller {
	...
	public function index() {
        ...
        $rt_id                  = $current_user_full_info->rt_id;
		...
		$this->load->view('ketua_rt/v_penilaian_alternatif', $data);
	}
    ...
    public function store() {
        ...
        if ($is_penilaian_alternatif_exists) {
            ...
            redirect("ketua_rt/penilaian_alternatif/?tahun_penilaian={$tahun_penilaian}");
        }
