  ...
  <script>
    $(document).ready(function() {
      ...
      $('.toggle_modal_tambah').on('click', function() {
        ...
        $('#xform_modal_tambah_dan_edit').attr('action', '<?= site_url('kasi_kesejahteraan_sosial/alternatif/store') ?>');
      ...
      $('.datatables').on('click', '.toggle_modal_edit', function() {
        ...
        $.ajax({
          url: '<?= site_url('kasi_kesejahteraan_sosial/alternatif/get_alternatif_by_id') ?>',
          type: 'POST',
          data: {
            alternatif_id
          },
          ...
          success: function(data) {
            ...
            $('#xform_modal_tambah_dan_edit').attr('action', '<?= site_url('kasi_kesejahteraan_sosial/alternatif/update') ?>');
      ...
      $('.datatables').on('click', '.toggle_swal_hapus', function() {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            window.location = "<?= site_url('kasi_kesejahteraan_sosial/alternatif/destroy/') ?>" + alternatif_id
          }
        });
      });
      ...
      $('#xdusun_id').on('change', function() {
        ...
        $.ajax({
          url: '<?= site_url("kasi_kesejahteraan_sosial/dusun/get_all_rt/") ?>' + dusun_id,
          type: 'POST',
          data: {
            dusun_id: dusun_id
          },
