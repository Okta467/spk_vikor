                ...
                <div class="x_title">
                  ...
                  <ul class="nav navbar-right panel_toolbox">
                    <div style="display: flex; flex-direction: row; align-items: center; justify-content: flex-end; width: 300px;">
                      ...
                      <li style="width: 65%">
                        <form method="get" action="<?= site_url('kasi_kesejahteraan_sosial/penilaian_alternatif/') ?>">
  ...
  <script>
    $(document).ready(function() {
      ...
      $('.datatables').on('click', '.toggle_modal_detail_penilaian', function() {
        ...
        $.ajax({
          url: '<?= site_url('kasi_kesejahteraan_sosial/penilaian_alternatif/get_penilaian_alternatif') ?>',
          type: 'POST',
          data: {
