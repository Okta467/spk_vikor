  ...
  <script>
    $(document).ready(function() {
      ...
      $('.datatables').on('click', '.toggle_modal_daftar_sub_kriteria', function() {
        ...
        $.ajax({
          url: '<?= site_url('kasi_kesejahteraan_sosial/kriteria/get_all_sub_kriteria') ?>',
          type: 'POST',
          data: {
            kriteria_id
          },
      ...
      $('.toggle_modal_tambah').on('click', function() {
        ...
        $('#xform_modal_tambah_dan_edit').attr('action', '<?= site_url('kasi_kesejahteraan_sosial/kriteria/store') ?>');
      ...
      $('.datatables').on('click', '.toggle_modal_edit', function() {
        ...
        $.ajax({
          url: '<?= site_url('kasi_kesejahteraan_sosial/kriteria/get_kriteria_by_id') ?>',
          type: 'POST',
          data: {
            kriteria_id
          },
          ...
          success: function(data) {
            ...
            $('#xform_modal_tambah_dan_edit').attr('action', '<?= site_url('kasi_kesejahteraan_sosial/kriteria/update') ?>');
      ...
      $('.datatables').on('click', '.toggle_swal_hapus', function() {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            window.location = "<?= site_url('kasi_kesejahteraan_sosial/kriteria/destroy/') ?>" + kriteria_id
          }
        });
      });
      ...
      $('.datatables').on('change', '.toggle_status_aktif_kriteria', function() {
        ...
        $.ajax({
          url: '<?= site_url('kasi_kesejahteraan_sosial/kriteria/set_status_aktif') ?>',
          type: 'POST',
          data: {
            kriteria_id
          },
