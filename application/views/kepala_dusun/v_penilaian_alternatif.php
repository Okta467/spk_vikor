                ...
                <div class="x_title">
                  ...
                  <ul class="nav navbar-right panel_toolbox">
                    <div style="display: flex; flex-direction: row; align-items: center; justify-content: flex-end; width: 300px;">
                      ...
                      <li style="width: 65%">
                        <form method="get" action="<?= site_url('kepala_dusun/Penilaian_Alternatif/') ?>">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" class="form-horizontal form-label-left" id="xform_modal_tambah_dan_edit" action="<?= site_url('kepala_dusun/Penilaian_Alternatif/store') ?>">
  ...
  <script>
    $(document).ready(function() {
      ...
      $('.datatables').on('click', '.toggle_modal_penilaian', function() {
        ...
        $('#xform_modal_tambah_dan_edit').attr('action', '<?= site_url('kepala_dusun/Penilaian_Alternatif/store') ?>');
      ...
      $('.datatables').on('click', '.toggle_modal_edit', function() {
        ...
        $.ajax({
          url: '<?= site_url('kepala_dusun/Penilaian_Alternatif/get_penilaian_alternatif') ?>',
          type: 'POST',
          data: {
          ...
          success: function(data) {
            ...
            $('#xform_modal_tambah_dan_edit').attr('action', '<?= site_url('kepala_dusun/Penilaian_Alternatif/update') ?>');
      ...
      $('.datatables').on('click', '.toggle_swal_hapus', function() {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            window.location = `<?= site_url('kepala_dusun/Penilaian_Alternatif/destroy/') ?>` + `${alternatif_id}/${tahun_penilaian}`
          }
        });
      });
