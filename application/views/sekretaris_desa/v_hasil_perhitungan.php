              ...
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <ul class="nav navbar-right panel_toolbox">
                    <div style="display: flex; flex-direction: row; align-items: center; justify-content: flex-end; width: 300px;">
                      ...
                      <li style="width: 60%">
                        <form method="get" action="<?= site_url('sekretaris_desa/Hasil_Perhitungan/') ?>">
                ...
                <div class="x_content">
                  <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                      <a href="<?= site_url("sekretaris_desa/Hasil_Perhitungan/print/?tahun_penilaian={$tahun_penilaian}") ?>" target="_blank" class="btn btn-primary" style="width: 100%">
