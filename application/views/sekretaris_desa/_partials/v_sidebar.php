  ...
  <div class="left_col scroll-view">
    ...
    <div class="profile clearfix">
      <div class="profile_pic">
        <a href="<?= site_url('sekretaris_desa/profile') ?>">
    ...
    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
      <div class="menu_section">
        ...
        <ul class="nav side-menu">
          ...
          <li><a href="<?= site_url('sekretaris_desa/alternatif') ?>"><i class="fa fa-user-md"></i> Data Alternatif </a></li>
          <li><a href="<?= site_url('sekretaris_desa/kriteria') ?>"><i class="fa fa-pencil-square-o"></i> Data Kriteria </a></li>
          <li><a href="<?= site_url('sekretaris_desa/sub_kriteria') ?>"><i class="fa fa-pencil-square-o"></i> Data Sub-Kriteria </a></li>
          <li <?= $is_penilaian_alternatif_selected ?>>
            <a href="<?= site_url('sekretaris_desa/penilaian_alternatif/?tahun_penilaian=' . date('Y')) ?>"><i class="fa fa-bar-chart"></i> Data Nilai </a>
          </li>
          <li <?= $is_hasil_perhitungan_selected ?>>
            <a href="<?= site_url('sekretaris_desa/hasil_perhitungan/?tahun_penilaian=' . date('Y')) ?>"><i class="fa fa-list-alt"></i> Data Hasil Perhitungan </a>
          </li>
          <li><a href="<?= site_url('sekretaris_desa/dusun') ?>"><i class="fa fa-building-o"></i> Data Dusun </a></li>
          <li><a href="<?= site_url('sekretaris_desa/rt') ?>"><i class="fa fa-road"></i> Data RT </a></li>
        </ul>
      </div>
    </div>
    <!-- /sidebar menu -->
