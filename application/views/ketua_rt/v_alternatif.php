          ...
          <form method="post" class="form-horizontal form-label-left" id="xform_modal_tambah_dan_edit">
            ...
            <div class="form-group col-md-6 col-sm-12 col-xs-12">
              ...
              <select name="xrt_id" id="xrt_id" class="form-control select2">
                <option value="<?= $user_rt_id ?>" selected><?= $user_rt ?></option>
              </select>
            </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('.toggle_modal_tambah').on('click', function() {
        ...
        $('#xform_modal_tambah_dan_edit').attr('action', '<?= site_url('ketua_rt/alternatif/store') ?>');
      ...
      $('.datatables').on('click', '.toggle_modal_edit', function() {
        ...
        $.ajax({
          url: '<?= site_url('ketua_rt/alternatif/get_alternatif_by_id') ?>',
          type: 'POST',
          data: {
            alternatif_id
          },
          ...
          success: function(data) {
            ...
            $('#xform_modal_tambah_dan_edit').attr('action', '<?= site_url('ketua_rt/alternatif/update') ?>');
      ...
      $('.datatables').on('click', '.toggle_swal_hapus', function() {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            window.location = "<?= site_url('ketua_rt/alternatif/destroy/') ?>" + alternatif_id
          }
        });
      });
      ...
      $('#xdusun_id').on('change', function() {
        ...
        $.ajax({
          url: '<?= site_url("ketua_rt/dusun/get_all_rt/") ?>' + dusun_id,
          type: 'POST',
          data: {
            dusun_id: dusun_id
          },
